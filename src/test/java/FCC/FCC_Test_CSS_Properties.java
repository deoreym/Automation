...
String Hex = "";
	...
	/*
	 HeaderMenuDash BC = rgba(0, 0, 0, 0)
HeaderMenuDash color = rgba(15, 200, 188, 1)
HeaderMenuDash padding = 8px 0px
HeaderMenuDash font-family = Alata
HeaderMenuDash font-size = 18px
HeaderMenuDash font-weight = 600
HeaderMenuDash line-height = 17px
HeaderMenuDash border-bottom-color = rgba(15, 200, 188, 1)
HeaderMenuSite BC = rgba(0, 0, 0, 0)
HeaderMenuSite color = rgba(220, 53, 69, 1)
HeaderMenuSite padding = 8px 0px
HeaderMenuSite font-family = Alata
HeaderMenuSite font-size = 18px
HeaderMenuSite font-weight = 600
HeaderMenuSite line-height = 17px
HeaderMenuSite border-bottom-color = rgba(220, 53, 69, 1)
FT2BC = rgba(0, 0, 0, 0)
PB BC = rgba(15, 200, 188, 1)
BC = rgba(255, 193, 7, 1)
Red: 15
Green: 200
Blue: 188
Hex of Menu Color Dash #0FC8BC
Red: 220
Green: 53
Blue: 69
Hex of Menu Color SA #DC3545
	 */
