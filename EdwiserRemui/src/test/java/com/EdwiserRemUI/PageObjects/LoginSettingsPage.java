...
public class LoginSettingsPage extends BasePage {
	...
	@FindBy(xpath = "//h6[normalize-space()='Logo settings']")
	...
	@FindBy(xpath = "//h6[normalize-space()='Login form settings']")
	...
	@FindBy(xpath = "//h6[normalize-space()='Login page settings']")
	...
	@FindBy(xpath = "//div[@class='login-container']//div//img[@class = 'navbar-brand-logo logo']")
	public WebElement logoOnLoginCard;
	
	@FindBy(xpath="//img[@class='navbar-brand-logo logo']")
	public List<WebElement> logoOnLoginPage;
	
	@FindBy(xpath = "//div[@class='login-description-container']//div//img[@class='navbar-brand-logo logo']")
	public WebElement logoOnCentralRegion;
	...
	@FindBy(xpath = "//div[@class='login-description']//p[1]")
